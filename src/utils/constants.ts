...
const MESSAGE_UNITY_UPLOAD_STORAGE_FULL = "スペースが十分ではありません。";
const MESSAGE_UNITY_UPLOAD_NO_FILES = "アップロードするファイルがありません。";
...
export {
  ...
  MESSAGE_UNITY_UPLOAD_STORAGE_FULL,
  MESSAGE_UNITY_UPLOAD_NO_FILES,
  HEADER_CREATOR_ID,
  HEADER_GAME_ID,
